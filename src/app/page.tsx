...
function RolesSection() {
  ...
  const roles = [
    ...
    },
    {
      ...
      fullTitle: "University Administrators", 
      description: "Manage departments, staff, and institution-wide policies",
      icon: Building2,
      position: 1,
    },
    {
      title: "Teachers",
      fullTitle: "Teachers",
      description: "Quick attendance marking with offline support",
      icon: GraduationCap,
      position: 2,
    },
    {
      ...
      description: "Assist with class coordination and record submission",
      icon: Users,
      position: 3,
    },
  ];
