...
class AttTrackerDB extends Dexie {
  ...
  constructor() {
    super('AttTrackerDB');
    // v13: cachedAnalytics gains a secondary index on sectionId so
    // invalidateAnalyticsCache can delete by exact sectionId instead of a
    // fragile primary-key prefix match (F-014).
    this.version(13).stores({
      ...
      cachedAnalytics:    'id, universityId, sectionId',
    });
